...
<head>
    ...
    <title>Anjos da Doação - Perfil</title>
        ...
        <div class="profile-wrapper mt-5 mb-5">
            <nav class="profile-nav">
                <div class="nav-wrapper">
                    <a href="./perfil/editar_perfil.php"><i class="fas fa-id-card"></i> Editar Perfil</a>
                    <a href="./perfil/cadastrar.php"><i class="fas fa-archive"></i> Cadastrar
                        Equipamento</a>
                    <a href="./perfil/seus_pedidos.php"><i class="fas fa-box-open"></i> Seus Pedidos</a>
                    <a href="./perfil/suas_doacoes.php"><i class="fas fa-clipboard-list"></i> Suas
                        Doações</a>
                </div>
            </nav>
