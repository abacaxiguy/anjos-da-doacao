...
<head>
    ...
    <title>Anjos da Doação - Suas doações</title>
        ...
        <div class="profile-wrapper mt-5 mb-5">
            <nav class="profile-nav">
                <div class="nav-wrapper">
                    ...
                    <a class="active" href="./suas_doacoes.php"><i class="fas fa-clipboard-list"></i> Suas
                        Doações</a>
                </div>
            </nav>
                    ...
                    <div class="order-wrapper container">
                        <div class="static-header mt-4">
                            <div class="order-number">
                                <span class="number-orders">0 doações</span>
                                em:
                            </div>
                            <div class="order-filter">
                                <select class="custom-select">
                                    <option value="p">Pendentes</option>
                                    <option value="r">Aprovados</option>
                                    <option value="c">Rejeitados</option>
                                </select>
                            </div>
                        </div>
                            ...
                            <div class="order-body mt-2 p-3">
                                <div class="body-wrapper">
                                    ...
                                    <div class="queue-place">
                                        Em análise pelo ponto de doação
                                    </div>
                                </div>
