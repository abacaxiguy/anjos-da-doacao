        ...
        <div class="profile-wrapper mt-5 mb-5">
            ...
            <div style="min-height: 300px;">
                <div class="buttons-container">
                    ...
                    <a class="left-button" href="./admin_solicitacao_doacao.php">
                        <h1><i class="fas fa-hand-holding-medical"></i></h1>
                        <p>Doação Solicitada</p>
                    </a>


                    <a class="right-button" href="./admin_solicitacao_pedido.php">
